...
public class CheckoutPage {
    ...
    public static final String CHEACKOUT_BUTTON = "[data-test='checkout']";
    ...
    public static final String COMPLETE_HEADER = "[data-test='subtotal-label']";

    public static final String ERROR_MESSAGE = "[data-test='error']";
    public static final String CHECKOUT_CONTAINER = ".checkout_info";
}
